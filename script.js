const app = {
  ...
  questions: [
    {
      ...
      rizzLine: "Till now, I was just doing fine, but now I can't stop thinking about you."
    },
    {
  ...
  loadQuestion() {
    ...
    optionsDiv.innerHTML = question.options.map(option => `<button>${option}</button>`).join('');
  },
  showWannaKnowPage() {
